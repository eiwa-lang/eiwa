...
- [x] **Verify:** `for_map_test.ei` verde (12/12) + suíte completa (`eiwac test samples/tests`, 434 PASSED) e `zig build test` verdes sem regressão em `for_lambda_test` / `for_index_test` / `arrays_and_loops_test`.
---
